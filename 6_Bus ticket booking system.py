...
# Note: abstract-> ekhane AbstractBus holo abstract base class, eitake inherit kortese bus class, oy bus er moddhe inherit kora jinis er jonno constractor, supper use kora lage nai, karon oi info gula abstract class theke inherit kora hois tai, etai asbtract class er power
